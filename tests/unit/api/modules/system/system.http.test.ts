    ...
    get.mockResolvedValue({
      data: {
        state: {
          ...
          permissions: [{ id: 'perm-1', role: 'Admin', members: 1, permissions: { resourceLibrary: true, storyboard: true, dubbing: true, systemMessage: true }, updatedAt: '2026-07-01T00:00:00.000Z' }],
          messages: [{ id: 'msg-1', title: 'Notice', summary: 'Summary', content: 'Body', status: 'unread', level: 'normal', relativeTime: 'just now', platform: 'web', loginMethod: 'password', location: 'CN', loginTime: '2026-07-01 10:00:00' }],
        },
      },
    })
