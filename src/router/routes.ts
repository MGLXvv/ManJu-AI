...
export const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'resources', name: 'resources', component: () => import('@/pages/placeholder/ResourceLibraryPage.vue') },
      { path: 'voices', name: 'voices', component: () => import('@/pages/placeholder/VoiceManagePage.vue') },
      ...
      { path: 'system', name: 'system', component: () => import('@/pages/placeholder/SystemManagePage.vue') },
