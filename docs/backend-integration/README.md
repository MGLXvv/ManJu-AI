...
- [`live-script-workspace.md`](./live-script-workspace.md)：可清理的 Script Workspace 读取、保存、确认和刷新恢复验证流程；
- [`script-workspace-implementation-notes.md`](./script-workspace-implementation-notes.md)：本轮 Adapter 边界、版本字段和未确认项；
